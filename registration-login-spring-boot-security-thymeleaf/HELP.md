...
* The original package name 'net.javaguides.registration-login-spring-boot-security-thymeleaf' is invalid and this project uses 'net.javaguides.registrationloginspringbootsecuritythymeleaf' instead.
